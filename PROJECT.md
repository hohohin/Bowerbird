...
> **Mac 26.9.2002 现成包发布（2026-09-21）：** 核验 R2 最新包后同步官网 Mac 清单与双首页，替代文档中尚待上传的 2001。更新包 86,394,528 bytes、SHA-256 03ef60428b9118efe7812ea8d3c57dcb255723ae63422c7e9f70dcc8c7b32ee3；完整下载/签名/篡改拒绝、ARM64/版本、候选/正式及公网验收通过。Windows 保持 26.9.1803，现役 20260921-mac-26.9.2002，回滚 20260920-video-lazyload，保留官网视频优化与旧包。未发布工作区尚未打包的桌面、后台、Worker 或数据库修改，原生升级和公证仍待验收。详见 [桌面自动更新](dev-doc/DESKTOP-UPDATES.md)。
