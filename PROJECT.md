...
- [AGENT-RUNTIME-PLAN.md](AGENT-RUNTIME-PLAN.md) — 仅运行 Bowerbird 官方内置 Skill 的 Agent Runtime 专项开发计划（Bowerbird Agent Kernel / VPS Worker / Supabase 控制面 / 方舟 API / 桌面 Agent UI，A0–A8，v1.1 2026-08-13）
