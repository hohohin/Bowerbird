...
- **收费化产品 UI 真机验收**：Supabase 迁移、Edge Functions、Secrets 与东京真实 API 闭环均已完成；待在桌面端走 Magic Link → 创作板 Bowerbird Cloud → 积分流水，并在官网验证同账号余额一致。跨会话接续细节见 [ARCH-ADJUST-PROGRESS.md](ARCH-ADJUST-PROGRESS.md)。
