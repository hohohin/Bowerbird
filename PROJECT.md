...
**2026-09-16 Windows 打包版本：** 继续使用两位年份的日期版本，Tauri 配置与 Cargo package/lock 同步为 26.9.16；根与前端 npm workspace 的 0.1.0 不作为安装包版本。安装包仅本地交付，旧包保留，当前 SHA-256 以上方最新复核为准。
